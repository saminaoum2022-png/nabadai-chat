(function () {
  ...
  style.textContent = `
    ...
    #nabad-header {
      ...
      background: linear-gradient(135deg, rgba(45,78,232,0.05), rgba(0,212,255,0.05));
    }
    #nabad-header .dot {
      width: 8px; height: 8px; border-radius: 50%;
      background: #00D4FF;
      box-shadow: 0 0 8px rgba(0,212,255,0.8); animation: pulse 2s infinite;
    }
    ...
    .nabad-msg.user {
      background: linear-gradient(135deg, #2D4EE8, #00D4FF); color: #ffffff;
    ...
    #nabad-lead input:focus {
      ...
      box-shadow: 0 0 0 3px rgba(0,212,255,0.1), 0 0 16px rgba(0,212,255,0.2);
    }
    #nabad-lead button {
    ...
    #nabad-input:focus {
      ...
      box-shadow: 0 0 0 3px rgba(0,212,255,0.1), 0 0 20px rgba(0,212,255,0.25);
    }
    #nabad-send {
      background: linear-gradient(135deg, #2D4EE8, #00D4FF); border: none; border-radius: 10px;
